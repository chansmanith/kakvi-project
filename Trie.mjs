...
export default class Trie {
    constructor() {
        ...
        this.searchWordPrefix = function (word) {
            let node = this.root;
        ...
        this.searchWord = function (prefix) {
            let node = this.root;
            let output = [];
        ...
        //write data to JSON
        this.save_to_json = function (file_name) {
            let node = this.root;
            let output = [];
            findAllWords(node, output);

            fs.writeFile(file_name, JSON.stringify(output), (err) => {
